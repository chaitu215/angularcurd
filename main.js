...
var BusinessService = /** @class */ (function () {
    ...
    */
    BusinessService.prototype.addBusiness = function (person_name) {
        var obj = {
            person_name: person_name
            // business_name: business_name,
            // business_gst_number: business_gst_number
...
var GstAddComponent = /** @class */ (function () {
    function GstAddComponent(fb, bs, http) {
        this.fb = fb;
        this.bs = bs;
        this.http = http;
        this.createForm();
    ...
    */
    GstAddComponent.prototype.addBusiness = function (person_name) {
        this.bs.addBusiness(person_name);
    };
    GstAddComponent.prototype.ngOnInit = function () {
        ...
        this.http.get('./res.json')
            .subscribe(function (data) {
            console.log('in http call get ');
            _this.actualData = data;
            console.log(_this.actualData);
        });
    };
    GstAddComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"], _business_service__WEBPACK_IMPORTED_MODULE_2__["BusinessService"], _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"]])
    ], GstAddComponent);
...
module.exports = __webpack_require__(/*! /Users/sravalyarushankkrishna/Desktop/Angular7CRUDExample-master/src/main.ts */"./src/main.ts");
